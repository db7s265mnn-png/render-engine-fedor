...
echo The .ocio file is the colour config (OCIO env / Film). FULL compiles the OpenColorIO library.
echo OCIO: prebuild zlib+minizip-ng 3.0.7, then VS + EXT_PACKAGES=MISSING (fixes zlib.h C1083).
