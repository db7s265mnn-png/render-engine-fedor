...
echo FULL uses a system OpenColorIO SDK if present (OpenColorIO_ROOT / Program Files / PATH).
echo Source-build OCIO only when that SDK is missing (need OpenColorIO.h and .lib, not just a .ocio file).
echo If OCIO is compiled from source, it uses the Visual Studio generator like CI.
