...
echo OCIO SDK: prebuild zlib/minizip/yaml-cpp/expat/pystring, then VS + EXT_PACKAGES=NONE (no expat_install).
echo Copies zlib.dll next to the exe (OpenColorIO_2_3.dll needs it).
