...
// kernel (intersect_closest, shade_surface, …). Same idea here, stripped to
// unidirectional PT + basic surfaces. Shade kernels never call optixTrace;
// intersect kernels never include the BSDF.
#pragma once
