...
| Sampling | Samples Per Pixel, Pixel Oracle (Uniform / Variance), Noise Threshold, Light Samples, Pixel Sampler, Sampling Type, Bucket Size, Seed, Direct / Indirect Clamp |
